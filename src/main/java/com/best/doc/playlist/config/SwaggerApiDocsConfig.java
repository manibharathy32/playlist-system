 ...
 * 
 */
package com.best.doc.playlist.config;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

import com.best.doc.playlist.common.Constant;
...
public class SwaggerApiDocsConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(Constant.APP_NAME).description(Constant.APP_DESC).termsOfServiceUrl("")
